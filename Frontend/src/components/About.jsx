    ...
    <section className="py-20 bg-white">
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="text-gray-600 text-lg leading-relaxed space-y-5">
          ...
          <p>
            I have worked on projects including customer churn
            analysis, dashboard development and an Electronic
            Stamping System designed to improve university payment
